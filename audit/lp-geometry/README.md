...
21 点中 **8 点が LP と厳密一致**、total |residual| = **4.747978 ss**。残る13点の内訳:

| residual | 原因 |
|---|---|
| −2.234 / −1.455 / −0.500 / −0.250 | **行頭**の key/time 変更が break-align 列に入っていない（§3.I・型の欠落） |
| −0.153 / −0.150 | 臨時記号→符頭の距離が Lily# 1.300 / LP 1.450（1件は rod 経由で入ってきたもの） |
| −0.002 / −0.0013 | 符頭幅に **advance を使っている**（LP は ink extent）。`ApplyLeftHeadWidth` |
| +0.0025 | 上と同種＋ナチュラル幅 0.6640 / LP 0.666666 |
| ±0.0002 ×2 / −0.00003 | `GlyphMetricsGenerated.cs` の4桁丸め |
| +0.00002 | 符尾の符頭接続オフセットのメトリクス差 |

**行中の clef/key 変更**（4点・6.843242 ss）は `1970b830` で潰れた（→ 0.000453 ss）。
