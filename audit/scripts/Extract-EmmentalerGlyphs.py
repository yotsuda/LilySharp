...
GLYPHS: list[tuple[str, str, str]] = [
    ...
    ("RestDoubleWholeLedgered", "rests.M1o", "breve off a staff line: ledger in the glyph"),
    ("RestWhole", "rests.0", ""),
    ("RestWholeLedgered", "rests.0o", "whole off a staff line: ledger in the glyph"),
    ("RestHalf", "rests.1", ""),
    ("RestHalfLedgered", "rests.1o", "half off a staff line: ledger in the glyph"),
    ("RestQuarter", "rests.2", ""),
    ("Rest8th", "rests.3", ""),
    ("Rest16th", "rests.4", ""),
    ("Rest32nd", "rests.5", ""),
