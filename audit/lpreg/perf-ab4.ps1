# A/B perf round 4 (session 107 dot-seed work): 1000-bar inputs,
# interleaved runs, min-of-5. Base = a26b4670 (pre-session-107).
# Heavy side of THIS change: dotted notes/chords (the seed now walks
# DotConfiguration + one row box per dotted item per skyline build).
$base = 'C:\MyProj\LilySharp-perfbase-a26b\LilySharp.Cli\bin\Release\net9.0\lysc.dll'
...
$inputs = @(
  ...
  @{ Name='hairpin1k (対照・dotted無し)'; File='C:\MyProj\LilySharp\audit\lpreg\perf-hairpin1k.lys' }
)
