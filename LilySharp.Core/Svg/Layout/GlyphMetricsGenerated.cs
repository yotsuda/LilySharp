...
internal static partial class GlyphMetrics
{
    ...
    /// <summary>Meter digit '0' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — zero (zero = U+0030 in this build)</remarks>
    public const double TimeSigDigit0Advance = 1.464000;

    /// <summary>Meter digit '1' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — one (one = U+0031 in this build)</remarks>
    public const double TimeSigDigit1Advance = 1.268000;

    /// <summary>Meter digit '2' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — two (two = U+0032 in this build)</remarks>
    public const double TimeSigDigit2Advance = 1.464000;

    /// <summary>Meter digit '3' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — three (three = U+0033 in this build)</remarks>
    public const double TimeSigDigit3Advance = 1.332000;

    /// <summary>Meter digit '4' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — four (four = U+0034 in this build)</remarks>
    public const double TimeSigDigit4Advance = 1.600000;

    /// <summary>Meter digit '5' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — five (five = U+0035 in this build)</remarks>
    public const double TimeSigDigit5Advance = 1.348000;

    /// <summary>Meter digit '6' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — six (six = U+0036 in this build)</remarks>
    public const double TimeSigDigit6Advance = 1.356000;

    /// <summary>Meter digit '7' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — seven (seven = U+0037 in this build)</remarks>
    public const double TimeSigDigit7Advance = 1.348000;

    /// <summary>Meter digit '8' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — eight (eight = U+0038 in this build)</remarks>
    public const double TimeSigDigit8Advance = 1.464000;

    /// <summary>Meter digit '9' advance width (plain fetaText cut)</summary>
    /// <remarks>LILYPOND-REF: mf/feta-numbers.mf — nine (nine = U+0039 in this build)</remarks>
