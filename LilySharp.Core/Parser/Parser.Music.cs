...
/// <remarks>The run is collected through <see cref="GreenRun"/>: 519 of these scans a keystroke
    ...
    private bool IsArticulationName()
    {
        ...
        // name is resolved by ArticulationRegistry, not by the lexer. (coda/segno/fine never
        // reach here: the navigation-mark branch in ParseArticulations takes them first and
        // reports LYS1022 — g1@coda is an error, a navigation mark is bare. Session 571 removed
        // the three arms that said otherwise.)
