...
終了時: **commit 2 本**（`35893e41` 部屋の移植 ＋ **この 1 本＝§1 と §2**）＝**未 push 6**・木 0・未追跡 0。**suite 6552 合格 / 0 失敗 / 4 skip / 合計 6556**（開始 6555 から **+1**＝**番人 1 本**）。Core 0 エラー 0 警告。**追跡 `.lys` 579 冊**（不動＝**本を 1 冊も足していない**）・**snapshot 229 枚**（不動＝**5 枚を*書き換えた***）。**台帳 744 点／exact 585／ss 非ゼロ 188／総和 24.714494359／count 156 中 2。**
