...
終了時: **commit 3 本**（**本体 `49886b42` ／ 緑歩き `c3451bda` ／ docs 1 本**）＝**未 push 9**・木 0・未追跡 0。**suite 6637 合格 / 0 失敗 / 4 skip / 合計 6641**（開始 6610 ではなく **6617** から **+24**＝**本便の網 24 ケース**）。Core 0 エラー 0 警告。**追跡 `.lys` 581 冊・snapshot 231 枚**（**書き換え 0・追加 0・削除 0**）・**台帳 748 点／exact 588／ss 非ゼロ 190／総和 24.714570188／count 158 中 2／`OPEN:` 0＝すべて不動。**
