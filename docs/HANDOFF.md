...
> ⚠️ **この節*だけ*で §1 の 20,000 字の門のうち 11,307 字を食う**（第453 実測＝**57%**。`TheHandoffStaysReadable`
> が測る「現在便」は **§1.0 ＋ その便の語り**なので、**1 便の語りに使えるのは約 8,700 字**）。
> ⇒ **詰まったら語りを削るのではなく、まずここの ✅ と重複を落とす**（第453 は ⒱・⒩⁵・⒩⁴の脇の ✅ 3 件と
