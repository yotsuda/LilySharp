...
第153 で閉じた**（red 生成/打鍵 plain 43k→9.1k・fingbeam 234k→57k・v2bow 37k→22.6k/4.1k・§1。
⚠️ gather 単独では合計 red は 1 個も動かず、**意味層の全木走査が次々に first-touch を相続した**
...
col.walk 行は第152/153 で stale。**▶ の値段の根拠は第149 の表（§1 の下の経緯ブロック）**——
