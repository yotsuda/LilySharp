...
終了時: **commit 2 本**（**本体 `bb6932e3` ＋ この 1 本**）＝**未 push 5**・木 0・未追跡 0。**suite 6613 合格 / 0 失敗 / 4 skip / 合計 6617**（開始 6610 から **+7**＝**本便の網 7 ケース**）。Core 0 エラー 0 警告。**追跡 `.lys` 581 冊・snapshot 231 枚**（**1 枚が書き換え・追加も削除も 0 枚**）・**台帳 748 点／exact 588／ss 非ゼロ 190／総和 24.714570188／count 158 中 2／`OPEN:` 0＝すべて不動。**
★★ **WSL ubuntu Release も同じ 6613 / 0 / 4 / 6617**（`bb6932e3` の木）。⚠️ **CI は `11f48202` までしか走っておらず、本便の 2 本を含む未 push 5 本は未実行。**
