...
- **:1910** would be output-moving with no observer, which is the one move HANDOFF 5.0 forbids.
### `LilySharp.Core/Svg/Layout/PedalEngraver.cs`
...
### `LilySharp.Core/Svg/Layout/OutsideStaffStacker.cs`
- **:1186** system would hand back marks placed without the labels under them. LILYSHARP-OWN
- **:3257** LILYSHARP-OWN: the SUPPORT entry cannot be passed on its far side.
