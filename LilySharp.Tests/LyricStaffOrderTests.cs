...
{
    private static (double LyricY, Dictionary<int, double> StaffY) LayoutOf(string src)
    {
        ...
        double lyricY = layout.LyricLayouts.First(l => !l.Item.IsLyricsRow).Y;
        return (lyricY, staffY);
    }
